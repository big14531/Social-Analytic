...
<head>
    ...
    <link rel="stylesheet" href="<?php echo(base_url());?>assets/css/social-analytic.css?version=1">
    ...
    <!-- DataTables -->
    <link rel="stylesheet" href="<?php echo(base_url());?>assets/admin-lite/plugins/datatables/dataTables.bootstrap.css">
